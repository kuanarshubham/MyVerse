...
const getSpaceWithId = asyncHandler(async(req, res)=> {
    res.json(new ApiResponse(200, {
        "dimensions": "100x200",
        "elements": [{
                 id: 1,
...
const addElementToSpace = asyncHandler(async(req, res)=> {
    res.json(new ApiResponse(200, {}));
});

const deleteElementToSpace = asyncHandler(async(req, res)=> {
    res.json(new ApiResponse(200, {}));
});
